...
with tab4:
   ...
   pred_df['outcome'] = pred_df['class'].replace({0:":-1: :thumbsdown: Unhealthy snack, please refrain from consuming",1:":+1: :thumbsup: Eat in moderation"})
   ...
   good_cookie_data = merged_subset_answer[(merged_subset_answer['type']=="cookie") & (merged_subset_answer['outcome'] ==":+1: :thumbsup: Eat in moderation")]
   good_cream_data = merged_subset_answer[(merged_subset_answer['type']=="cream")& (merged_subset_answer['outcome'] ==":+1: :thumbsup: Eat in moderation")]
   good_wafer_data = merged_subset_answer[(merged_subset_answer['type']=="wafer")& (merged_subset_answer['outcome'] ==":+1: :thumbsup: Eat in moderation")]
   good_cracker_data = merged_subset_answer[(merged_subset_answer['type']=="cracker")& (merged_subset_answer['outcome'] ==":+1: :thumbsup: Eat in moderation")]
