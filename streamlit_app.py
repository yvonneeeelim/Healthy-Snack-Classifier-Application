...
with tab1:
   ...
   sugar = float(st.number_input("Enter Sugar (g):", min_value=0, step=1, value=1))
   fats = float(st.number_input("Enter Fats (g):", min_value=0, step=1, value=1))
   sodium = float(st.number_input("Enter Sodium (g):", min_value=0, step=1, value=1))
   serving_size = float(st.number_input("Enter Serving Size (g):", min_value=0, step=1, value=1))
